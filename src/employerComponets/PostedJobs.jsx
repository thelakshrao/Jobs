      ...
      <div className="rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 mb-4">
        ...
        {job.externalCareerUrl && (
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="text-xs font-semibold text-slate-500 hover:text-[#004aac] underline underline-offset-2 break-all transition-colors"
          >
            {job.externalCareerUrl}
          </a>
        )}
      ...
      >
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <Link
            ...
            className="inline-flex items-center gap-2 px-5 py-2.5 text-white text-sm font-bold rounded-xl transition-all shadow-md no-underline"
            style={{
              backgroundColor: BRAND,
              boxShadow: "0 8px 20px rgba(0,74,172,0.25)",
            }}
            onMouseEnter={(e) =>
        ...
        >
          <div className="relative shrink-0">
            ...
            <input
              ...
              className="pl-9 pr-4 py-2.5 text-sm font-semibold text-slate-800 bg-white border border-slate-200 rounded-xl outline-none focus:ring-2 w-64 placeholder:font-normal placeholder:text-slate-400"
              style={{ "--tw-ring-color": "rgba(0,74,172,0.35)" }}
            />
          </div>
          <div className="relative shrink-0">
            <Search
            ...
            <input
              ...
              className="pl-9 pr-4 py-2.5 text-sm font-semibold text-slate-800 bg-white border border-slate-200 rounded-xl outline-none focus:ring-2 w-50 placeholder:font-normal placeholder:text-slate-400"
              style={{ "--tw-ring-color": "rgba(0,74,172,0.35)" }}
            />
          </div>
          <button
        ...
        {jobs.length === 0 ? (
          <div className="bg-white rounded-2xl border border-slate-200 flex flex-col items-center justify-center py-24 px-6 text-center shadow-sm">
            ...
            >
              <Briefcase size={28} style={{ color: BRAND }} />
            </div>
            ...
            <Link
              href="/employer/dashboard/create-job"
              className="inline-flex items-center gap-2 px-7 py-3 text-white text-sm font-bold rounded-xl transition-all shadow-md no-underline"
              style={{
                backgroundColor: BRAND,
                boxShadow: "0 8px 20px rgba(0,74,172,0.25)",
              }}
                        ...
                        <div className="lg:hidden flex items-center gap-2 mt-3 pt-3 border-t border-slate-100">
                          {job.status === "Draft" ? (
                            <Link
                              ...
                              className="flex items-center gap-1.5 px-4 py-2 rounded-lg text-xs font-bold text-white transition-colors no-underline shadow-sm"
                        ...
                        <div className="flex items-start justify-between gap-4">
                          ...
                          <div className="flex items-center gap-2 shrink-0">
                            ...
                            {job.status === "Draft" ? (
                              <Link
                                href={`/employer/dashboard/create-job?draftId=${job.id}`}
                                className="flex items-center gap-1.5 px-4 py-1.5 rounded-lg text-xs font-bold text-white transition-colors no-underline shadow-sm"
                                style={{ backgroundColor: BRAND }}
                              >
                ...
                <div className="flex gap-2 pt-2">
                  {sheetJob.status === "Draft" ? (
                    <Link
                      ...
                      className="flex-1 flex items-center justify-center gap-1.5 px-4 py-2.5 rounded-xl text-sm font-bold text-white transition-colors no-underline shadow-sm"
                      style={{ backgroundColor: BRAND }}
                    >
