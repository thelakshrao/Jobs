  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        <p className="text-xs truncate" style={{ color: BLUE }}>
          {exp.company}
        </p>
...
export default function ProfileCard({
  ...
  const handleSaveExp = () => {
    if (editSection === "exp-new") {
      saveExpToFirebase([...experiences, expForm]);
    } else {
  ...
  const handleSaveEdu = () => {
    if (editSection === "edu-new") {
      saveEduToFirebase([...educations, eduForm]);
    } else {
  ...
  const addLanguage = (val) => {
    ...
    if (trimmed && !langList.includes(trimmed)) {
      setAboutForm({ ...aboutForm, languages: [...langList, trimmed] });
    }
    setLangInput("");
  };
      ...
      <div className="px-4 pt-4 pb-5">
        <div className="flex items-center gap-3 mb-3">
          <div className="shrink-0">
            {profile.photoURL ? (
              <img
                ...
                style={{ border: "2.5px solid #e2e8f0" }}
              />
            ) : (
              <div
                className="w-14 h-14 sm:w-18 sm:h-18 rounded-2xl flex items-center justify-center text-xl sm:text-2xl font-extrabold text-white"
                style={{ backgroundColor: BLUE, border: "2.5px solid #e2e8f0" }}
              >
          ...
          <div className="flex-1 min-w-0">
            ...
            >
              {profile.name || (
                <span className="italic text-gray-300 font-normal text-sm">
                  Your name here
                </span>
              )}
            </h2>
            {profile.title ? (
              <p className="text-xs sm:text-base font-semibold mt-0.5 truncate">
          ...
          <div className="flex flex-col gap-3 mt-1">
            ...
            <div className="flex gap-2">
              <input
                ...
                className="rounded-xl px-3 py-2 text-xs outline-none flex-1 min-w-0"
                style={{ border: "1.5px solid #e2e8f0", color: "#0f172a" }}
              />
